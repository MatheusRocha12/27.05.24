 ...
 * */
class Pessoa {
    constructor (nome, idade, peso, altura, cor, musicalidade, corpo, coordenacao_motora, 
        ritmo, ano_nascimento, mes_nascimento, dia_nascimento, 
        nome_pai, nome_mae, rg, cpf, endereco, numero_endereco, bairro, cidade, 
        estado, cep, whatsapp, facebook, instagram, twiter_x, linkedin, email, 
        tiktok, youtube, snapchat, orkut, tinder, uber, app_99, profissao, nacionalidade, 
        estado_civil, possui_deficiencia, cnh, passaporte, religiao, partido_politico, 
        idioma, figurino) 
...
class Musica {
    constructor (nome, artista, ritmo, genero, velocidade, idioma, 
        ano, tempo, tipo, compasso, autor, compositor, 
        musica, letra, instrumentos, volume, vocalista, 
        baterista, guitarrista, baixista, sonoplasta) 
...
var musica =[];
musica[0] = new Musica("ram tchum","Ana Castela", "animado", "sertanejopop", "rápido", "português" )
musica[1] = new Musica("Pipocou","Ana Castela", "animado", "sertanejopop", "rápido", "português" )
musica[2] = new Musica("Clima de Rodeio","DJ Chris no Beat", "animado", "sertanejopop", "rápido", "português")

class Ritmo {
    constructor (musica,movimento, tempo, velocidade, quantidade_de_pessoas, som, compasso, coreografia, 
        nome, bpm, sincronia, harmonia, vestimentas, 
        genero_musical, maquiagens, equipamentos, local_de_ensaio, melodia, 
        composicao, compositor, instrumentos) 
...
class LocalDoEnsaio {
    constructor (espaco, largura, altura, profundidade, energia, som, musica, 
        microfone, palco, cadeira, capacidade_de_pessoas, equipamentos_de_luz, 
        internet, cabo_de_energia, apresentacoes, stands, disponibilidade, 
        seguranca, horario_de_funcionamento, acessibilidade, publico, artistas, 
...
class Banheiro {
    constructor (genero, produtos, torneira, vaso,  mictorio, espelho, piso, agua, energia, 
        toalha_de_papel, suporte_de_sabonete, sabonete, suporte_de_bolsa, 
        lixeira, descarga, encanamento, odorizante, lampada, porta, interruptor, 
        sensor_de_luz, janela, macaneta, batente) 
